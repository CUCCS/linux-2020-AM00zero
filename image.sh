...
[OPTION]
	...
	[-p prefix] [-s suffix] [-j] [-- help] [-f --file]
[DECRIPTION] 
	This script can do a variety of batch jobs on images.

	-d, --directory     		    the file name of image or the directoey path of images
	-q, --quality           change the compress qualities of jpg/jpeg images
	-r, --resolution        resize your jpg/jpeg/svg/png images with original aspect ratio
	-w, --watermark         add watermark to jpg/jpeg/png images
